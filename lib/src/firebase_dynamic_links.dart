  ...
  Future<PendingDynamicLinkData?> retrieveDynamicLink() async {
    ...
    if (linkData['android'] != null) {
      final Map<dynamic, dynamic> data =
          linkData['android'] as Map<dynamic, dynamic>;
      androidData = PendingDynamicLinkDataAndroid._(
        data['clickTimestamp'] as int,
        data['minimumVersion'] as int,
      );
    }
    ...
    if (linkData['ios'] != null) {
      final Map<dynamic, dynamic> data =
          linkData['ios'] as Map<dynamic, dynamic>;
      iosData = PendingDynamicLinkDataIOS._(data['minimumVersion'] as String);
    }

    return PendingDynamicLinkData._(
      Uri.parse(linkData['link'] as String),
      androidData,
      iosData,
    );
  }
